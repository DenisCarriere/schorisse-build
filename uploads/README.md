...
The real site references are stored in `uploads/site-reference/`:

- `photo-1-shared-laneway.jpg` — left side of the barn; shared tractor access,
  photographed from the pasture/valley end looking back toward the rear/gate.
  The panoramic glass gable is therefore immediately beside the camera and the
  long-wall opening order recedes as kitchen, stair, then bedroom pair. Preserve
  the hedge-to-wall clearance, gate and working lane.
...
visualizations. The bird's-eye markup fixes site relationships; the generated
model and `models/design.json` fix building geometry.
